...
ALLOWED_HOSTS = ['localhost','127.0.0.1', '192.241.132.37']
...
SOCIALACCOUNT_PROVIDERS = {
    ...
    'google': {
        'APP': {
            ...
            'secret': str(os.getenv('GOOGLE_CLIENT_ID')),
            'key': ''
        }
    },
    'twitter': {
...
# Alphavantage key
ALPHAVANTAGE_KEY1 = str(os.getenv('NQIJO29RYZ1GVI9U'))
ALPHAVANTAGE_KEY2 = str(os.getenv('KVEH6Q6D5MAV38A0'))
ALPHAVANTAGE_KEY3 = str(os.getenv('BSKKDP85PSOOCHU9'))


NEWSAPI_KEY = '4e84f494761c4478940c1a8d15a1a5a7'